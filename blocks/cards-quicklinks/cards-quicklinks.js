...
export default function decorate(block) {
  ...
  ul.querySelectorAll('picture > img').forEach((img) => {
    // Quick-link icons are small SVGs — leave them untouched (do not run through
    // createOptimizedPicture, which would rewrite them to the raster pipeline and break them).
